...
var SearchCityView = (function () {
    function SearchCityView(j$) {
        ...
        this.input.focusout(function (event) { return _this.onInputFocusOut(event); });
        this.hidePlaces();
    ...
    SearchCityView.prototype.onInputFocusOut = function (event) {
        var _this = this;
        setTimeout(function () { return _this.hidePlaces(); }, 200);
    };
