...
class CountryLayerView extends TextLayerView{
    ...
    protected onDestroy() {
        EventBus.removeEventListener(EditorEvent.CITY_CHANGED, (data)=>this.onCountryChanged(data));
        EventBus.removeEventListener(EditorEvent.TEXT_2_CHANGED, (data)=>this.onCountryTextChanged(data));
    }
