...
var CountryLayerView = (function (_super) {
    ...
    CountryLayerView.prototype.onDestroy = function () {
        var _this = this;
        EventBus.removeEventListener(EditorEvent.CITY_CHANGED, function (data) { return _this.onCountryChanged(data); });
        EventBus.removeEventListener(EditorEvent.TEXT_2_CHANGED, function (data) { return _this.onCountryTextChanged(data); });
    };
